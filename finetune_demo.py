...
from models.cogvlm_model import FineTuneCogVLMModel
...
def disable_untrainable_params(self):
    total_trainable = 0
    enable = ["mixins.mlp.vision", "mixins.rotary.vision", "word_embedding", "vit", "linear_proj", "boi", "eoi", 'dense_h_to_4h', 'dense_4h_to_h']
...
FineTuneCogVLMModel.disable_untrainable_params = disable_untrainable_params
...
if __name__ == '__main__':
    ...
    py_parser = FineTuneCogVLMModel.add_model_specific_args(py_parser)
    ...
    model, args = FineTuneCogVLMModel.from_pretrained(args.from_pretrained, args, overwrite_args={'model_parallel_size': args.model_parallel_size} if args.model_parallel_size != 1 else {})
